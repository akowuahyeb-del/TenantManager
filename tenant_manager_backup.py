...
# Labels aligned to TENANTS sheet
form["A4"]  = "Tenant ID"
form["A5"]  = "Full Name / Company"
form["A6"]  = "Phone"
form["A7"]  = "Email"
form["A8"]  = "ID / Reg No."
form["A9"]  = "Room Number"
form["A10"] = "Unit Type"
form["A11"] = "Floor / Block"
form["A12"] = "Contract Start"
form["A13"] = "Contract End"
form["A14"] = "Monthly Rent"
form["A15"] = "Currency"
form["A16"] = "Payment Frequency"
form["A17"] = "Deposit Paid"
form["A18"] = "Payment Method"

# Yellow input cells
for cell in [
    "B4",   # Tenant ID
    "B5",   # Full Name / Company
    "B6",   # Phone
    "B7",   # Email
    "B8",   # ID / Reg No.
    "B9",   # Room Number
...
# Column widths
form.column_dimensions["A"].width = 25
