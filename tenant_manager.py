...
fields = [
    ...
    (21, "Emergency Contact",    "D21"),
    (22, "Relationship",         "D22"),
    (23, "Emergency Phone",      "D23"),
    (24, "Residential Address",  "D24"),
...
form.merge_cells("B38:D38")
form["B38"] = "Tenant Signature"

form.merge_cells("E38:F38")
form["E38"] = "Property Manager"

for cell in ["B39", "E39"]:
    form[cell].fill = fill(C["yellow_inp"])
    form[cell].border = border(style="medium")

form.merge_cells("A42:G42")
c = form["A42"]
...
form.merge_cells("D44:F45")

btn = form["D44"]
btn.value = "▶ SUBMIT TENANT"

btn.fill = fill(C["teal"])
btn.font = font(
    bold=True,
    color=C["white"],
    size=12
